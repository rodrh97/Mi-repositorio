...
<!--left navigation start-->
      ...
      <label for="matricula" class="panel-title row col-lg-8 mx-auto">Nombre Completo</label>
      <div class="row col-lg-8 mx-auto"><input class="form-control" id="id" type="text" placeholder="Rodrigo Rojas Huerta"></div>
      </div>

      <!--Nombre -->
      <div class="form-group">
        <label for="nombre" class="panel-title row col-lg-8 mx-auto">Fecha de Nacimineto</label>
      <div class="row col-lg-8 mx-auto"><input class="form-control" id="nombre" type="date"></div>
      </div>
       <!--Botones --> 
      <div class="btn col-md-7">
        <button class="btn btn-custom">Guardar</button>
        <a href="form_venta_cliente.php"><button class="btn btn-warning" type="button">Cancelar</button></a>
      </div>
