...
<!--left navigation start-->
                ...
                <div id="page-right-content">
                  <h1>Hacer Venta con Cliente</h1>
                  <br>
                    <div class="container">
                              <form action="" class="container">
      <!--Matricula -->
      <div class="form-group">
      <label for="matricula" class="panel-title row col-lg-2">Ingresar codigo del producto</label>
      <div class="row col-lg-3">
        <input class="form-control" id="id" type="text" placeholder="123456789">
        </div>
        <div class="row col-lg-3 mx-auto">
        <button class="btn btn-warning">Poner Producto en la tabla</button>
        </div>
      </div><br><br>

<div class="form-group">
      <label for="matricula" class="panel-title row col-lg-2">Ingresa el nombre del cliente</label>
        <div class="row col-lg-5 mx-auto"><select class="form-control" name="" id="option" placeholder="Elige tu opcion">
        <option value="">Nombre5</option>
        <option value="">Nombre4</option>}
        <option value="">Nombre3</option>
        <option value="">Nombre2</option>
    <option value="">Nombre1</option>
      </select></div>
        <div class="row col-lg-6 mx-auto">
        <h6 class="h6"><b>SI NO EXISTE CLIENTE PRESIONA EL BOTON</b></h6><a href="form_nuevo_cliente.php"><button class="btn btn-warning" type="button">Agregar Cliente</button></a>
        </div>
      </div>
                    ...
                    <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Productos Comprados</h4>
                              ...
                              <!--Nombre -->
      <div class="form-group">
        <label for="nombre" class="panel-title row col-lg-8 mx-auto">Total de Productos</label>
      <div class="row col-lg-5 mx-auto"><input class="form-control" id="nombre" type="text"></div>
      </div>
      <br>
      <br>
      <div class="form-group">
        <label for="nombre" class="panel-title row col-lg-8 mx-auto">Total Neto</label>
      <div class="row col-lg-5 mx-auto"><input class="form-control" id="nombre" type="text"></div>
      </div>
      <br>
      <br>
      <div class="form-group">
        <label for="nombre" class="panel-title row col-lg-8 mx-auto">Total</label>
      <div class="row col-lg-5 mx-auto"><input class="form-control" id="nombre" type="text"></div>
      </div>
      <br>
      <br>
      <div class="btn col-md-11">
        <a href="ventas.php"><button class="btn btn-success" type="button">Terminar</button></a>
        <a href="ventas.php"><button class="btn btn btn-danger " type="button">Cancelar</button></a>
      </div>
